...
const app = {
  state: {
    ...
    lang: 'zh-CN',
    _antLocale: {},
    aegisKey: process.env.VUE_APP_AEGIS_KEY,
    aegisSecret: process.env.VUE_APP_AEGIS_SECRET,
    reportUrl: 'http://172.16.232.130:8000/',
    serverUrl: 'http://172.16.232.130:8000',
    period: { period: dayjs().date() < 10 ? "lastMonth" : "month", start: null, end: null }
  },
  mutations: {
    RECORD_PERIOD: (state, period) => {
      state.period = period
    },
