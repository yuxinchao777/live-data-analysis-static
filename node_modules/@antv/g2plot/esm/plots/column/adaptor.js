...
export function adaptor(params, isBar) {
    ...
    state, geometry, meta, axis, legend, columnTooltip, slider, scrollbar, label, interaction, animation, annotation(), conversionTag(options.yField, !isBar, !!seriesField), // 有拆分的时候禁用转化率
