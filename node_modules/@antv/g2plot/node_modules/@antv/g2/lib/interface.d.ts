...
export declare type CustomOption = any;
...
/** 小提琴图 shape 关键点信息 */
export declare type ViolinShapePoint = ShapePoint & {
    _size?: number[];
};
...
export declare type AnnotationPositionCallback = (xScales: Scale[] | Record<string, Scale>, yScales: Scale[] | Record<string, Scale>) => [number | string, number | string];
...
export declare type TooltipTitle = string | ((title: string, datum: Datum) => string);
 ...
 * 事件 payload
 */
export declare type EventPayload = LooseObject & {
    /** 触发事件的来源 */
    source?: string;
};
export declare type EventCallback = (event: LooseObject) => void;
/**
 * todo: 事件名可穷举，后续需要补充
 * 事件配置项
 */
 ...
 * 缩略轴的配置项
 */
export declare type SliderOption = SliderCfg | boolean;
/** 滚动条组件配置项 */
...
/** 滚动条配置 */
export declare type ScrollbarOption = ScrollbarCfg | boolean;
/** 配置项声明式 */
...
export declare type AllLegendsOptions = LegendCfg | Record<string, LegendOption> | boolean;
/** G2 支持的度量类型 */
...
/** createTheme 主题样式表配置 */
export declare type StyleSheetCfg = Pick<StyleSheet, 'backgroundColor' | 'subColor' | 'brandColor' | 'paletteQualitative10' | 'paletteQualitative20' | 'paletteSemanticRed' | 'paletteSemanticGreen' | 'paletteSemanticYellow' | 'paletteSequence' | 'fontFamily'>;
/** 交互反馈的定义 */
...
export declare type ViewAppendPadding = number | number[];
