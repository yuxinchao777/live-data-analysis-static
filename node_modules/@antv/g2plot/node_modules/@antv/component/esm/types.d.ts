...
export declare type LocationType = 'point' | 'Region' | 'points' | 'circle' | 'none';
export { Point, BBox };
...
export declare type TooltipPosition = 'top' | 'left' | 'right' | 'bottom' | 'auto';
