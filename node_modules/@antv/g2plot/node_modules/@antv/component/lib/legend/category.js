...
var Category = /** @class */ (function (_super) {
    ...
    Category.prototype.getDefaultCfg = function () {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, cfg), { name: 'legend', type: 'category', itemSpacing: 24, itemMarginBottom: 8, maxItemWidth: null, itemWidth: null, itemHeight: null, itemName: {}, itemValue: null, maxWidth: null, maxHeight: null, marker: {}, items: [], itemStates: {}, itemBackground: {}, pageNavigator: {}, defaultCfg: {
                title: {
                    spacing: 5,
                    style: {
                        fill: theme_1.default.textColor,
    ...
    Category.prototype.drawArrow = function (group, currentPoint, name, direction, size, style) {
        ...
        var shape = this.addShape(group, {
            ...
            name: name,
            attrs: tslib_1.__assign({ path: [['M', x + size / 2, y], ['L', x, y + size], ['L', x + size, y + size], ['Z']], cursor: 'pointer' }, style),
        });
