...
function geometry(params) {
    ...
    var color = options.color, colorField = options.colorField, rectStyle = options.rectStyle, hierarchyConfig = options.hierarchyConfig;
...
function adaptor(params) {
    return utils_1.flow(defaultOptions, common_1.theme, geometry, axis, common_1.legend, common_1.tooltip, interaction, common_1.animation, common_1.annotation())(params);
}
