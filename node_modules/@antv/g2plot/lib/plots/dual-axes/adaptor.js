...
function slider(params) {
    ...
    if (slider) {
        ...
        leftView.on('slider:valuechanged', function (evt) {
            ...
            render_sider_1.renderSlider(rightView, value);
        });
        chart.once('afterpaint', function () {
            ...
            if (!util_1.isBoolean(slider)) {
                ...
                if (start || end) {
                    render_sider_1.renderSlider(rightView, [start, end]);
                }
            }
        });
    }
...
function adaptor(params) {
    ...
    return utils_1.flow(transformOptions, geometry, meta, axis, limitInPlot, tooltip, interaction, annotation, theme, animation, color, legend, slider)(params);
}
