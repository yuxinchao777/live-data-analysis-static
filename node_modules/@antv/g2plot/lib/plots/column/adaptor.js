...
function adaptor(params, isBar) {
    ...
    common_1.state, geometry, meta, axis, legend, columnTooltip, common_1.slider, common_1.scrollbar, label, common_1.interaction, common_1.animation, common_1.annotation(), conversion_tag_1.conversionTag(options.yField, !isBar, !!seriesField), // 有拆分的时候禁用转化率
