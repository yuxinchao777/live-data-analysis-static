...
function meta(params) {
    ...
    var yField = options.yField, maxAngle = options.maxAngle, data = options.data;
    var processData = utils_2.processIllegalData(data, yField);
...
function adaptor(params) {
    return utils_1.flow(geometry, meta, axis, coordinate, common_1.interaction, common_1.animation, common_1.theme, common_1.tooltip, common_1.legend, common_1.annotation(), label)(params);
}
