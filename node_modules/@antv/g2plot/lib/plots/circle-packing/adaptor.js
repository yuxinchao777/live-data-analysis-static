...
function adaptor(params) {
    return utils_1.flow(defaultOptions, padding, common_1.theme, meta, geometry, axis, common_1.legend, tooltip, interaction, common_1.animation, common_1.annotation())(params);
}
